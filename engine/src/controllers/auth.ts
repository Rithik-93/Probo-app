...
export const createSymbol = (req: QueueReq) => {
...
export const mintToken = (req: QueueReq) => {
  const { userId, stockSymbol } = req.body as MintReqType;
...
export const reset = (req: QueueReq) => {
